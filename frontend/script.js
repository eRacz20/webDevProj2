...
const DEFAULT_IMG =
"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTtmhk5_HuVd4Rc1-9RtFIpS9wB4od2wOvEEw&s";
...
async function load(){
    ...
    j.movies.forEach(m => {
        ...
        // if no image url → default
        let img = m.image_url || DEFAULT_IMG;
...
async function add(){
    ...
    let data = {
        ...
        genre: genre.value,
        rating: rating.value,
        image_url: image.value || DEFAULT_IMG
    };
